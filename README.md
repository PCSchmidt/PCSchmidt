...
- 🔬 [Inference Optimization Study](https://github.com/PCSchmidt/inference-optimization-study) — 9× throughput improvement via ONNX Runtime + INT8 quantization on DistilBERT
- 🧮 [Optimizer Deep Dive](https://github.com/PCSchmidt/optimizer-deep-dive) — SGD → Adam from scratch in pure NumPy (~93% MNIST accuracy)
